export const ar = {
  ...
  "about.p1":
    "إن كنت تشعر بحاجة لتجربة أماكن مختلفة أو تنوي زيارة مدينة لا تعرف عنها الكثير، فإن تطبيق ونس يساعدك على اكتشاف أماكن بالقرب منك والعديد من المدن الأخرى حول العالم.",
  "about.p2":
